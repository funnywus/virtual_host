...
.upload-page::before {
  ...
  background-image: 
    ...
    radial-gradient(circle at 80% 70%, rgba(88, 86, 214, 0.04) 0%, transparent 50%);
  pointer-events: none;
  z-index: 0;
}
...
.stat-card:nth-child(1) { background: rgba(0, 122, 255, 0.08); }
.stat-card:nth-child(2) { background: #FFFFFF; }
.stat-card:nth-child(3) { background: #FFFFFF; }
